...
(ip.geoip.asnum in {15169} and not http.user_agent wildcard "*googlebot/2.1*" and not http.user_agent wildcard "*google-read-aloud*" and not http.user_agent wildcard "*mediapartners-google*" and not http.user_agent wildcard "*googlebot-image*") or
(ip.src in {
