...
(http.user_agent wildcard "*chrome/139*") or
...
(ip.src in {
    ...
    12.127.44.138        13.95.133.245        2.189.5.162
    ...
    43.166.247.82        192.42.116.194       103.97.254.3
    164.92.86.220        45.141.215.114       162.240.153.125
    191.101.157.169      47.128.252.64        185.177.72.60
})
```

<div align="right">
    <h4>📥 » Last update: 25.02.2026 [DD.MM.YYYY]</h4>
</div>